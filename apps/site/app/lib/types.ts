...
export type FitnessPoint = {
  ...
  aerobicDecouplingMovingDurationSeconds: number | null;
  aerobicDecouplingValidSegmentCount: number | null;
  aerobicDecouplingHrCoverageRatio: number | null;
  aerobicDecouplingMaximumHrGapSeconds: number | null;
  firstHalfSpeedKmh: number | null;
  secondHalfSpeedKmh: number | null;
  firstHalfAvgHeartRate: number | null;
  secondHalfAvgHeartRate: number | null;
  firstHalfEfficiencyRatio: number | null;
  secondHalfEfficiencyRatio: number | null;
  aerobicDecouplingPrior90dCount: number | null;
  aerobicDecouplingPrior90dMedian: number | null;
  aerobicDecouplingPrior90dQ1: number | null;
  aerobicDecouplingPrior90dQ3: number | null;

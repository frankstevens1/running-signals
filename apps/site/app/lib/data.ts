...
const FITNESS_SELECT = [
  ...
  "aerobic_decoupling_pct", "aerobic_decoupling_status", "aerobic_decoupling_unavailable_reason",
  "aerobic_decoupling_moving_duration_seconds", "aerobic_decoupling_valid_segment_count",
  "aerobic_decoupling_hr_coverage_ratio", "aerobic_decoupling_maximum_hr_gap_seconds",
  "first_half_speed_kmh", "second_half_speed_kmh", "first_half_avg_heart_rate",
  "second_half_avg_heart_rate", "first_half_efficiency_ratio", "second_half_efficiency_ratio",
  "aerobic_decoupling_prior_90d_count", "aerobic_decoupling_prior_90d_median",
  "aerobic_decoupling_prior_90d_q1", "aerobic_decoupling_prior_90d_q3",

alter table public.site_fitness_core
    add column previous_aerobic_decoupling_pct double precision,
    add column previous_distance_economy_m_per_beat double precision,
    add column previous_elevation_economy_m_per_beat double precision,
    add column previous_prior_7d_distance_km double precision;
...
select
    ...
    fitness.aerobic_decoupling_failed_gates,
    fitness.previous_aerobic_decoupling_pct,
    fitness.previous_distance_economy_m_per_beat,
    fitness.previous_elevation_economy_m_per_beat,
    fitness.previous_prior_7d_distance_km
